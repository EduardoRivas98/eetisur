...
|
*/
$prefixprotocol = (isset($_SERVER['HTTPS']) ? "https://" : "http://");
$config['base_url'] = $prefixprotocol.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST']."/" : '');
...
|
*/
$config['encryption_key'] = hex2bin('031be0d2a3b5ac3bdcf4f0111654bbeb');
