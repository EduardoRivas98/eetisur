...
class Api_Auth
{
    ...
    */
    private $encryptKey = 'asgh7ash191ms91js9178s1y78ja89h98asdj9sa'; //random generated secret key
    private $secretIV = 'nasms901k10miu1we129jasda@jk9192$@!%$!'; //random generated initialization vector

    
    private $isTokenExpire=true; //set true for token expiry, false for never expire
    private $tokenExpriryInHours=3; //token expiry time in Hours
